...
var camera = new THREE.PerspectiveCamera(45, window.innerWidth / window.innerHeight, 0.1, 1000); // 렌더러 정의 및 크기 지정, 문서에 추가하기
...
document.body.appendChild(renderer.domElement); // 빛을 생성해서

var light1 = new THREE.PointLight(0xffffff, 1, 100); // 위치를 적당한 지점에 놓고

light1.position.set(5, 5, 5); // 장면에 추가합니다.

scene.add(light1); // 빛을 또한 생성해서

var light2 = new THREE.PointLight(0xffffff, 1, 100); // 위치를 적당한 지점에 놓고

light2.position.set(7, -5, 6); // 장면에 추가합니다.

scene.add(light2); // 빛을 또한 생성해서

var light3 = new THREE.PointLight(0xffffff, 1, 100); // 위치를 적당한 지점에 놓고

light3.position.set(-7, 3, 3); // 장면에 추가합니다.

scene.add(light3);
var floor = new THREE.Mesh(new THREE.BoxGeometry(10, 0.0, 10), new THREE.MeshStandardMaterial({
  color: 0xffcc99
}));
scene.add(floor);
var cube = Array();
...
for (i = 0, x = 0, z = 0; i < 20; ++i) {
  height = Math.random() * 2 + 1; // 정육면체 하나 만들기

  cube.push(new THREE.Mesh(new THREE.BoxGeometry(0.6, height, 0.6), new THREE.MeshStandardMaterial({
...
var framesPerSecond = 60; // 에니메이션 효과를 자동으로 주기 위한 보조 기능입니다.
...
animate();
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
...
require("./3d");
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
},{"./3d":1,"./chat":2,"./login":4,"./notifications":5,"./paint":6,"./sockets":8}],4:[function(require,module,exports){
"use strict";
...
},{"./paint":6}],8:[function(require,module,exports){
"use strict";
...
},{"./chat":2,"./notifications":5,"./paint":6,"./players":7}]},{},[3])